NAME = pinak1180/passnger_docker
VERSION = 1.0

.PHONY: all build_all \
	build_customizable build_ruby19 build_ruby20 build_ruby21 build_ruby22 \
	build_nodejs build_full \
	tag_latest release clean

all: build_all

build_all: build_customizable build_ruby19 build_ruby20 build_ruby21 build_ruby22 build_nodejs build_full
